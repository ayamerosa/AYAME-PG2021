...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		-0.5, -0.5, 0.0, 0.0f, 1.0f, 0.0f, //verde
		 0.5, -0.5, 0.0, 0.0f, 0.0f, 1.0f, //azul
		 0.0, 0.5, 0.0, 1.0f, 0.0f, 0.0f //vermelho
	...
	glBufferData(GL_ARRAY_BUFFER, 18 * sizeof(GLfloat), vertices, GL_STATIC_DRAW);//Envia os dados do array de floats para o buffer da OpenGl
